...
int main()
{
    ...
    while (true)
    {
        ...
        case 18:
            Node *newHead = NULL;
            // create_node(&newHead, 1);
            break;

        case 19:
            // concatenate_lists(a,b);
            // You need to create two lists and pass their heads as arguments to this function
            // The function returns head of concatenated list
            // Assign it to one of your lists and print it
            break;
        case 20:
            // are_lists_equal(a,b);
            // You need to create two lists and pass their heads as arguments to this function
            // The function returns true if lists are equal else false
            break;
        case 21:
            exit(0);
        default:
